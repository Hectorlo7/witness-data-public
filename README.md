...
|--------|--------------|---------------|
| Oncology | [oncology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/oncology/oncology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/oncology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=oncology_1k) |
| Cardiology | [cardiology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/cardiology/cardiology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/cardiology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=cardiology_1k) |
| Neurology | [neurology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/neurology/neurology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/neurology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=neurology_1k) |
| Pathology | [pathology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/pathology/pathology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/pathology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=pathology_1k) |
| Radiology | [radiology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/radiology/radiology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/radiology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=radiology_1k) |
| Endocrinology | [endocrinology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/endocrinology/endocrinology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/endocrinology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=endocrinology_1k) |
| Pharmacology | [pharmacology_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/pharmacology/pharmacology_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/pharmacology?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=pharmacology_1k) |
| Rare Disease | [rare_disease_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/rare_disease/rare_disease_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/rare_disease?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=rare_disease_1k) |
| Surgical | [surgical_sample_1k.csv](https://github.com/Hectorlo7/witness-data-public/blob/main/samples/surgical/surgical_sample_1k.csv) | [Download 1k records →](https://witness-data-factory.onrender.com/free-sample/surgical?utm_source=github_factory&utm_medium=readme&utm_campaign=get_started&utm_content=surgical_1k) |

Paid packs (10k → 1M records) sold via **AWS Data Exchange** and delivered via entitlement + presigned download URL. [Order now →](https://witness-data-factory.onrender.com/?utm_source=github_factory&utm_medium=readme&utm_campaign=enterprise&utm_content=paid_tiers)
...
Every record passes the **WITNESS GATE** before delivery, and ships with a machine-readable `qa_certificate.json` documenting:
...
Every record passes a **95% Witness Ensemble Gate** before delivery.

Two independent LLMs score each record in a blind consensus configuration. Records below the 97% threshold are discarded and regenerated — the gate is never relaxed.

- Batch ID and certificate timestamp
- Records requested / pool generated / records delivered
- Average, median, min, and max Witness Gate consensus scores
...
Full schema definitions for all 9 domains: [schemas/](https://github.com/Hectorlo7/witness-data-public/blob/main/schemas)

Full field reference: [docs/schema_overview.md](https://github.com/Hectorlo7/witness-data-public/blob/main/docs/schema_overview.md)
...
Full examples (load, validate, HuggingFace): [docs/quickstart.md](https://github.com/Hectorlo7/witness-data-public/blob/main/docs/quickstart.md)
...
| Resource | URL |
|----------|-----|
| Live Platform | [witnessdatafactory.store](https://witnessdatafactory.store/?utm_source=github_factory&utm_medium=readme&utm_campaign=links_table&utm_content=platform) |
| Free Evaluation Datasets | [huggingface.co/WitnessDataFactory](https://huggingface.co/WitnessDataFactory) |
| Enterprise Orders (AWS Data Exchange) | [witnessdatafactory.store](https://witnessdatafactory.store/?utm_source=github_factory&utm_medium=readme&utm_campaign=links_table&utm_content=enterprise) |
| Public Sample Repo | [github.com/Hectorlo7/witness-data-public](https://github.com/Hectorlo7/witness-data-public) |
